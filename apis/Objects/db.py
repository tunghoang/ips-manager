...
class Object(__db.Base):
  ...
  def __repr__(self):
    return '<Object idObject={} name={} idNode={} description={} >'.format(self.idObject, self.name, self.idNode, self.description, )

  def json(self):
    return {
      "idObject":self.idObject,"name":self.name,"idNode":self.idNode,"description":self.description,
    }
